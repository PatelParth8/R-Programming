# Question 1
# A random sample of 10 students produced the following data, where x is the midterm exam score out of 50, and y is the final exam score out of 100.
# Can you predict the final exam score of a random student if you know the midterm exam score?
...
#Question 2
# A random sample of 10 employee considered, where x is the year of experience and y is the salary of employee.
# Can you predict the salary of the person if you know the year of experience?
...
# Take hp (Gross horsepower) as a x value and Miles per gallon as y.
# Take first 10 records as sample from both fields.
# Predict value of mpg where hp is 94.
# Also plot linear regression. Add labels, title, plot shape, color and change plot size.
